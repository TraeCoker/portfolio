...
export const Contact = () => {
  return (
    <div className="container mt-64 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full animate-fade-in-up-s">
		<section className="w-full">
			...
			<div className="mt-12 mb-12">
				...
				<div className="flex mt-20 space-x-6">
					...
					<a href="https://twitter.com/trae_coker" className="text-secondary underline mt-3 block hover:text-selected-text">
						Twitter
					</a>
				</div>
			</div>		
